export const getSubscriptionCancelPage = (
  redirectUrl: string,
) => `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Bolaji Editions — Subscription Cancelled</title>
    <style>
      :root {
        --tint: #6C63FF;
        --bg: #F9F8FF;
  ...
  <body>
    <div class="card">
      ...
      <p>If this was a mistake or you’d like to try again, you can return to the site to restart your subscription.</p>

      <strong>No payment has been made.</strong>
